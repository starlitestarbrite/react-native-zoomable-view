...
class ReactNativeZoomableView extends _react.Component {
  ...
  async _zoomToLocation(x, y, newZoomLevel) {
    ...
    if (!this.props.zoomEnabled) return;
    (_this$props$onZoomBef = (_this$props11 = this.props).onZoomBefore) === null || _this$props$onZoomBef === void 0 ? void 0 : _this$props$onZoomBef.call(_this$props11, null, null, this._getZoomableViewEventObject()); // == Perform Zoom Animation ==
