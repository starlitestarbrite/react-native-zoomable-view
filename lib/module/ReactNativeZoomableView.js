...
class ReactNativeZoomableView extends Component {
   ...
   */
  _invokeOnTransform() {
    var _this$props$onTransfo, _this$props10, _this$props$onStaticP2, _this$props11, _this$debouncedOnStat;
    ...
    (_this$props$onStaticP2 = (_this$props11 = this.props).onStaticPinPositionMove) === null || _this$props$onStaticP2 === void 0 ? void 0 : _this$props$onStaticP2.call(_this$props11, this._staticPinPosition());
  ...
  _handlePinching(e, gestureState) {
    var _this$props$onZoomAft, _this$props12;
    ...
    this.zoomAnim.setValue(this.zoomLevel);
    (_this$props$onZoomAft = (_this$props12 = this.props).onZoomAfter) === null || _this$props$onZoomAft === void 0 ? void 0 : _this$props$onZoomAft.call(_this$props12, e, gestureState, this._getZoomableViewEventObject());
  }
  /**
  ...
  async _zoomToLocation(x, y, newZoomLevel) {
    var _this$props$onZoomBef, _this$props13, _this$props$onZoomAft2, _this$props14;

    if (!this.props.zoomEnabled) return;
    (_this$props$onZoomBef = (_this$props13 = this.props).onZoomBefore) === null || _this$props$onZoomBef === void 0 ? void 0 : _this$props$onZoomBef.call(_this$props13, null, null, this._getZoomableViewEventObject()); // == Perform Zoom Animation ==
    ...
    (_this$props$onZoomAft2 = (_this$props14 = this.props).onZoomAfter) === null || _this$props$onZoomAft2 === void 0 ? void 0 : _this$props$onZoomAft2.call(_this$props14, null, null, this._getZoomableViewEventObject());
  }
  /**
